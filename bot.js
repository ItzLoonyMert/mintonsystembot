...
if (message.author.id !== '347379495528824832') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
let embed = new Discord.RichEmbed()
     ...
     .setThumbnail(message.author.avatarURL)
     .setFooter("By : @LoonyMert_EG#4999 ")
